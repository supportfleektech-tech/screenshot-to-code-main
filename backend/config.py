...
# OpenAI-compatible gateways (see llm_gateways.py). Each one is just another
# base URL + key for the same Chat Completions API, so the app can run on a
# free or low-cost tier without a provider-specific SDK.
OPENROUTER_API_KEY = os.environ.get("OPENROUTER_API_KEY", None)
OPENROUTER_BASE_URL = os.environ.get("OPENROUTER_BASE_URL", None)
NVIDIA_API_KEY = os.environ.get("NVIDIA_API_KEY", None)
NVIDIA_BASE_URL = os.environ.get("NVIDIA_BASE_URL", None)
KILO_API_KEY = os.environ.get("KILO_API_KEY", None)
